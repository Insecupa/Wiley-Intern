...
public class BankApp {
	...
	public static void main(String[] args) {
		...
		BankAccount bankAccount1 = new BankAccount(101, "John Doe", 430, savingsAccount);
		bankAccount1.depositAmount(100.0);
		BankAccount bankAccount2 = new BankAccount(102, "Won Goe", 750.23, savingsAccount);
		BankAccount bankAccount3 = new BankAccount(103, "Pan Joe", 1540.23, currentAccount);
